...
public class GraphStoreProtocolGraphDB implements Component, SequentialExecution {

    private static final Logger LOG
            = LoggerFactory.getLogger(GraphStoreProtocolGraphDB.class);
    ...
    public GraphStoreProtocolGraphDBConfiguration configuration;
    ...
    public void execute() throws LpException {
        if (configuration.getEndpoint() == null
            ...
            throw exceptionFactory.failure("Missing property: {}",
                    GraphStoreProtocolGraphDBVocabulary.HAS_CRUD);
        }
        //
    ...
    private void uploadGraphDB(String url, File file, String mimeType,
    ...
    private void executeHttp(HttpEntityEnclosingRequestBase httpMethod)
        ...
        if (!configuration.isUseAuthentification()) {
            ...
            LOG.info("Using Basic Authentication: {} {} ", configuration.getUserName(), configuration.getPassword());
            ...
            String userPwStr = configuration.getUserName() + ":" + configuration.getPassword();
            httpMethod.addHeader("Authorization", "Basic " +
            		Base64.getEncoder().encodeToString(userPwStr.getBytes()));
        }
        ...
        if (configuration.isUseAuthentification()) {
            ...
            try (final CloseableHttpResponse response
                ...
                try {
                    LOG.info("Empty Request Response:\n {} ",
        ...
        LOG.info("Executing request: " + httpMethod.getRequestLine());
        try (final CloseableHttpResponse response
            ...
            try {
            	...
            	LOG.error("Response entity was null.", ex);
            }
