...
public final class GraphStoreProtocolGraphDBVocabulary {

    private static final String PREFIX
            = "http://plugins.linkedpipes.com/ontology/l-graphStoreProtocolGraphDB#";
    ...
    private GraphStoreProtocolGraphDBVocabulary() {
    }
